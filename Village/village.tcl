...
set tracefd     [open village.tr w]
set namf	[open village.nam w]
...
# configure node
	...
	for {set i 0} {$i < $val(nn) } {incr i} {
		...
		$ns_ initial_node_pos $node_($i) 500
	}
...
$ns_ duplex-link $n70  $n74 1.5Mb 10ms DropTail
$ns_ duplex-link $n71  $n72 1.5Mb 10ms DropTail
$ns_ duplex-link $n70  $n72 1.5Mb 10ms DropTail
$ns_ duplex-link $n71  $n73 1.5Mb 10ms DropTail
$ns_ duplex-link $n70  $n73 1.5Mb 10ms DropTail
$ns_ duplex-link $n72  $n73 1.5Mb 10ms DropTail
$ns_ duplex-link $n74  $n71 1.5Mb 10ms DropTail
...
$ns_ attach-agent $n74 $udp1
$ns_ attach-agent $n71 $null1
...
$ns_ attach-agent $n71 $udp2
$ns_ attach-agent $n72 $null2
...
$ns_ attach-agent $n70 $udp3
$ns_ attach-agent $n72 $null3
...
$ns_ attach-agent $n70 $udp4
$ns_ attach-agent $n73 $null4
...
$ns_ attach-agent $n71 $udp5
$ns_ attach-agent $n73 $null5
...
$ns_ attach-agent $n72 $udp6
$ns_ attach-agent $n73 $null6
